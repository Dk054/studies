...
provider "yandex" {
  token = "y0_AgAAAAAQzOOBAATuwQAAAADrF7KObTz6hSLhT7mxl6uLajSv69um8hA"
  cloud_id = "b1gt7bp2grqbho73ke1l"
  folder_id = "b1g7l8ost343t9a9r3g3"
  zone = "ru-central1-b"
}
resource "yandex_compute_instance" "vm-1" {
  name = "terraform1"
  ...
  metadata = {
    user-data = "${file("/home/dk1/7.3/meta.txt")}"
  }
